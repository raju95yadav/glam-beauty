      ...
      <AnimatePresence mode="wait">
        {activeTab === 'profile' ? (
          ...
          <motion.div 
            ...
            className="glass-card space-y-8"
          >
            <div className="flex items-center justify-between p-6 bg-nykaa-surface/5 rounded-3xl border border-nykaa-border">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-nykaa-text">Dashboard Theme</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
               {['Light Mode', 'Dark Mode'].map((mode, i) => (
                 <div 
                   ...
                   `}
                 >
                   <div className={`mb-4 w-full aspect-video rounded-none transition-colors ${i === 0 ? 'bg-gray-100 flex items-center justify-center' : 'bg-nykaa-bg flex items-center justify-center'}`}>
                      {i === 0 ? <Sun className="text-gray-400" /> : <Moon className="text-nykaa-text-muted" />}
                   </div>
                   <p className="text-center font-bold text-nykaa-text">{mode}</p>
                 </div>
               ))}
            </div>
          </motion.div>
