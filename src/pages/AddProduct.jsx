            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  required
                  rows="6"
                  className="input-glass resize-none font-medium text-sm leading-relaxed text-nykaa-text"
            ...
            >
              ...
              {product.imagePreview ? (
                ...
                <div className="flex flex-col items-center text-center p-6">
                  ...
                  <p className="text-[10px] text-nykaa-text-muted font-bold uppercase tracking-widest mt-2">or click to browse</p>
                </div>
              )}
            </div>
          </motion.div>
